...
<br />
<div align="center">
  <h2 align="center">Login & Register Page</h2>

  <h4 align="center">  
    <br />
    <a href="https://github.com/pauloaraujo028/login-register-responsivo/issues/new" target="_blank">Relatar Bug</a>
    ·
    <a href="https://github.com/pauloaraujo028/login-register-responsivo/issues/new" target="_blank">Recurso de Solicitação</a>
  </h4>
</div>
...
<img width="1493" alt="login-page" src="https://user-images.githubusercontent.com/105018299/192902739-54444852-cf91-4ec2-8614-ebb43bb8737f.jpg"><img width="1493" alt="login-page" src="https://user-images.githubusercontent.com/105018299/192902746-33c7e5e7-068f-4215-9b6a-b53ecaa2f054.jpg">
...
Página de Login & Registro design responsivo,  utilizável em todos os dispositivos. Todas funcionalidades estão funcionando perfeitamente, É um projeto excelente, sendo construído com HTML5 & CSS3. Espero que goste.
...
### Clonar-localmente
- Digite essa url: [https://github.com/pauloaraujo028/login-register-responsivo](https://github.com/pauloaraujo028/login-register-responsivo) no seu navegador.
